<script lang="ts">
	...
	const posts = [
		{ id: 'first-post', title: '첫 번째 포스트', content: '첫 번째 포스트의 내용입니다.' },
		{ id: 'second-post', title: '두 번째 포스트', content: '두 번째 포스트의 내용입니다.' },
		{ id: 'third-post', title: '세 번째 포스트', content: '세 번째 포스트의 내용입니다.' }
	];
	function goToFirstPost() {
		const firstPostId = posts[0].id;
		goto(`/post/${firstPostId}`);
	}
</script>
